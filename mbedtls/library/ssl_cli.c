...
static int ssl_parse_server_hello(mbedtls_ssl_context *ssl)
{
    ...
    mbedtls_printf("\nerver hello, version %d %d", buf[0], buf[1]);
    ...
    mbedtls_printf("\nserver hello, random bytes %d", buf[2]+2);
    if (n > 32) {
        MBEDTLS_SSL_DEBUG_MSG(1, ("bad server hello message"));
        mbedtls_ssl_send_alert_message(ssl, MBEDTLS_SSL_ALERT_LEVEL_FATAL,
                                       MBEDTLS_SSL_ALERT_MSG_DECODE_ERROR);
    ...
    mbedtls_printf(	"\nserver hello, chosen ciphersuite: %04x", (unsigned) i);
...
static int ssl_write_certificate_verify(mbedtls_ssl_context *ssl)
{
    ...
    if ((ret = mbedtls_ssl_derive_keys(ssl)) != 0) {
        MBEDTLS_SSL_DEBUG_RET(1, "mbedtls_ssl_derive_keys", ret);
		mbedtls_printf("\n mbedtls_ssl_derive_keys ret = %d", ret);
        return ret;
    }

    if (!mbedtls_ssl_ciphersuite_cert_req_allowed(ciphersuite_info)) {
        MBEDTLS_SSL_DEBUG_MSG(2, ("<= skip write certificate verify"));
		mbedtls_printf("\n<= skip mbedtls_ssl_ciphersuite_cert_req_allowed write certificate verify");
        ssl->state++;
        return 0;
    }
    ...
    if (ssl->client_auth == 0 || mbedtls_ssl_own_cert(ssl) == NULL) {
        MBEDTLS_SSL_DEBUG_MSG(2, ("<= skip write certificate verify"));
		mbedtls_printf("\n<= skip mbedtls_ssl_own_cert write certificate verify");
...
sign:
    ...
    if ((ret = mbedtls_ssl_write_handshake_msg(ssl)) != 0) {
        MBEDTLS_SSL_DEBUG_RET(1, "mbedtls_ssl_write_handshake_msg", ret);
		mbedtls_printf("\n mbedtls_ssl_write_handshake_msg ret = %d", ret);
        return ret;
    }
...
int mbedtls_ssl_handshake_client_step(mbedtls_ssl_context *ssl)
{
    ...
    mbedtls_printf("\nclient state: %d", ssl->state);

    if ((ret = mbedtls_ssl_flush_output(ssl)) != 0) {
        mbedtls_printf("\nmbedtls_ssl_flush_output failed");
        return ret;
    }
    ...
    if (ssl->conf->transport == MBEDTLS_SSL_TRANSPORT_DATAGRAM &&
        ...
        if ((ret = mbedtls_ssl_flight_transmit(ssl)) != 0) {
            mbedtls_printf("\nmbedtls_ssl_flight_transmit failed");
            return ret;
        }
    }
#endif /* MBEDTLS_SSL_PROTO_DTLS */
    ...
    switch (ssl->state) {
        ...
        case MBEDTLS_SSL_CLIENT_HELLO:
            ...
            mbedtls_printf("\nMBEDTLS_SSL_CLIENT_HELLO ret = %d", ret);
            break;
        ...
        case MBEDTLS_SSL_SERVER_HELLO:
            ...
            mbedtls_printf("\nMBEDTLS_SSL_SERVER_HELLO ret = %d", ret);
            break;

        case MBEDTLS_SSL_SERVER_CERTIFICATE:
            ret = mbedtls_ssl_parse_certificate(ssl);
            mbedtls_printf("\nMBEDTLS_SSL_SERVER_CERTIFICATE ret = %d", ret);
            break;

        case MBEDTLS_SSL_SERVER_KEY_EXCHANGE:
            ret = ssl_parse_server_key_exchange(ssl);
            mbedtls_printf("\nMBEDTLS_SSL_SERVER_KEY_EXCHANGE ret = %d", ret);
            break;

        case MBEDTLS_SSL_CERTIFICATE_REQUEST:
            ret = ssl_parse_certificate_request(ssl);
            mbedtls_printf("\nMBEDTLS_SSL_CERTIFICATE_REQUEST ret = %d", ret);
            break;

        case MBEDTLS_SSL_SERVER_HELLO_DONE:
            ret = ssl_parse_server_hello_done(ssl);
            mbedtls_printf("\nMBEDTLS_SSL_SERVER_HELLO_DONE ret = %d", ret);
            break;
        ...
        case MBEDTLS_SSL_CLIENT_CERTIFICATE:
            ...
            mbedtls_printf("\nMBEDTLS_SSL_CLIENT_CERTIFICATE ret = %d", ret);
            break;

        case MBEDTLS_SSL_CLIENT_KEY_EXCHANGE:
            ret = ssl_write_client_key_exchange(ssl);
            mbedtls_printf("\nMBEDTLS_SSL_CLIENT_KEY_EXCHANGE ret = %d", ret);
            break;

        case MBEDTLS_SSL_CERTIFICATE_VERIFY:
            ret = ssl_write_certificate_verify(ssl);
            mbedtls_printf("\nMBEDTLS_SSL_CERTIFICATE_VERIFY ret = %d", ret);
            break;

        case MBEDTLS_SSL_CLIENT_CHANGE_CIPHER_SPEC:
            ret = mbedtls_ssl_write_change_cipher_spec(ssl);
            mbedtls_printf("\nMBEDTLS_SSL_CLIENT_CHANGE_CIPHER_SPEC ret = %d", ret);
            break;

        case MBEDTLS_SSL_CLIENT_FINISHED:
            ret = mbedtls_ssl_write_finished(ssl);
            mbedtls_printf("\nMBEDTLS_SSL_CLIENT_FINISHED ret = %d", ret);
            break;
        ...
        case MBEDTLS_SSL_SERVER_NEW_SESSION_TICKET:
            ...
            mbedtls_printf("\nMBEDTLS_SSL_SERVER_NEW_SESSION_TICKET ret = %d", ret);
            break;
#endif

        case MBEDTLS_SSL_SERVER_CHANGE_CIPHER_SPEC:
            ret = mbedtls_ssl_parse_change_cipher_spec(ssl);
            mbedtls_printf("\nMBEDTLS_SSL_SERVER_CHANGE_CIPHER_SPEC ret = %d", ret);
            break;

        case MBEDTLS_SSL_SERVER_FINISHED:
            ret = mbedtls_ssl_parse_finished(ssl);
            mbedtls_printf("\nMBEDTLS_SSL_SERVER_FINISHED ret = %d", ret);
            break;

        case MBEDTLS_SSL_FLUSH_BUFFERS:
            MBEDTLS_SSL_DEBUG_MSG(2, ("handshake: done"));
            ssl->state = MBEDTLS_SSL_HANDSHAKE_WRAPUP;
            mbedtls_printf("\nMBEDTLS_SSL_FLUSH_BUFFERS SSL: STATE = %d", ssl->state);
            break;
